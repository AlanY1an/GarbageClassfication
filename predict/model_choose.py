...
class TrainingConfig:
    """Training configuration class to manage basic model training parameters"""
...
class ModelChoose:
    """Model selection and initialization class, supporting loading multiple deep learning models and handling pre-trained weights"""
    ...
    def _create_model_factory(self, model_func: Callable) -> torch.nn.Module:
        """
        General model creation factory method
    ...
    def initialize_model(self) -> torch.nn.Module:
        ...
        """
        # Use the mapping dictionary to get the model creation function
